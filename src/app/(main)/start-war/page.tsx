...
const StartWarPage = () => {
  ...
  const handleStartWar = () => {
    const data = {
      passage: "lorem asd fa sd as df sdf wd s dfe sdd gew fs dgw  sd fwe fsdf",
  ...
  return (
    <div className="flex-1 flex flex-col gap-10 pt-20 items-start justify-start max-w-4xl mx-auto w-full">
